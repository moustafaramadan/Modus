$(function() {
  ...
  const gaugeElement = document.querySelector(".gauge-1");
...
function setGaugeValue(gauge, value) {
  ...
  gauge.querySelector(".gauge1__cover").textContent = `${Math.round(
    value * 100
  )}%`;
}
...
const gaugeElement2 = document.querySelector(".gauge-2");
...
const gaugeElement3 = document.querySelector(".gauge-3");
...
function setGaugeValue3(gauge, value) {
  ...
  gauge.querySelector(".gauge3__cover").textContent = `${Math.round(
    value * 100
  )}%`;
}

setGaugeValue3(gaugeElement3, 0.8);



const gaugeElement4 = document.querySelector(".gauge-4");
...
function setGaugeValue4(gauge, value) {
  ...
  gauge.querySelector(".gauge4__cover").textContent = `${Math.round(
    value * 100
  )}%`;
}

setGaugeValue4(gaugeElement4, 1);

let slides= document.querySelectorAll("#slide")
let btn1= document.getElementById("btn-1")
let btn2= document.getElementById("btn-2")

btn1.onclick= function check(){
  for(i=0;i<slides.length;i++){
  slides[i].classList.toggle('active')
}};

btn2.onclick= function check(){
  for(i=0;i<slides.length;i++){
  slides[i].classList.toggle('active')
}};
...
let nav=document.getElementById("MODUS-Nav")
